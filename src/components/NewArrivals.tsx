...
//             <div className="container mx-auto border-b border-black/10 md:pb-[64px] pb-10 px-4">
//                 <CommonHeading text="New Arrivals" myClass="!mb-[55px]" />
//                 <Swiper
...
//                         <SwiperSlide key={item.id} className='pb-16 xl:pb-2'>
...
//                     ))}
//                 </Swiper>
//                 <CommonButton text="View All" myClass="px-[80px] !justify-center py-[13px] max-sm:!w-full !text-black !bg-white !border-black/10 !flex !mx-auto mt-7 md:mt-[36px]" />
//             </div>
//         </section>
//     );
// };
...
const Page = () => (
    <>
        ...
        {/* <CommonProductSlider title="Best Sellers" data={BEST_SELLERS_DATA} />
        <CommonProductSlider title="Trending Now" data={TRENDING_DATA} /> */}
    </>
);
